...
| 運用観点 | Shingan v0.8.7 | CI fail-on-finding に切り替えるのに必要 |
|---|:---:|---|
...
| `// shingan:ignore` 行 / ファイル単位コメント | ✅ | — |
| Severity policy as code (`.shingan.yaml`、ルール / パス単位) | ✅ | — |
...
| Plugin SDK (community ルール) | ✅ v0.9 (`experimental:`) | ABI 安定保証は v1.0 (ADR-010) |
